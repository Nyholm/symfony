...
use Symfony\Component\Messenger\Bridge\AmazonSns\Transport\AmazonSnsReceiver;
use Symfony\Component\Messenger\Bridge\AmazonSns\Transport\AmazonSnsTransport;
...
class AmazonSnsTransportTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->receiver = $this->createMock(AmazonSnsReceiver::class);
        $this->sender = $this->createMock(SenderInterface::class);

        $this->transport = new AmazonSnsTransport($this->connection, null, $this->receiver, $this->sender);
    }
    ...
    public function testReceivesMessages()
    {
        ...
        $connection->method('get')->willReturn($snsEnvelope);
    ...
    private function getTransport(SerializerInterface $serializer = null, Connection $connection = null)
    {
        ...
        return new AmazonSnsTransport($connection, $serializer);
    }
